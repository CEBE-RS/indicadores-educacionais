...
THEMES = [
    ...
    dict(id="saeb", nome="SAEB", arquivo="dados_saeb.xlsx",
         fonte="INEP/SEDUC-RS - SAEB por escola (Rede Estadual)", datasets=["saeb"],
         desc="Proficiencias do SAEB (Rede Estadual RS) em Lingua Portuguesa e Matematica por etapa e municipio (2017-2025)."),
